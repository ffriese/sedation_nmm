    ...
    \begin{tikzpicture}
        \begin{axis}
            ...
            \addplot[
                ...
                dashed,
                red,
            ] {22*0.035*x*e^(-0.035*x)};

            \legend{$h_e(t)=0.325\frac{mV}{ms} te^{-\frac{0.1}{ms}t} $, $ h_i(t)=1.1\frac{mV}{ms} te^{-\frac{0.05}{ms}t} $,
                $LOL why didnt i do this earlier$};
    ...
    \begin{tikzpicture}
        \begin{axis}
            ...
            \addplot[
                ...
                thick,
                green,
            ] {(3.01/10.8)*x*e^(-(1/10.8)*x)};\label{plot:line1}
            \addplot[
                domain = 0:140,
                samples = 200,
                smooth,
                thick,
                lime,
            ] {(7.07/4.6)*x*e^(-(1/4.6)*x)};\label{plot:line2}
            \addplot[
                domain = 0:140,
                samples = 200,
                smooth,
                thick,
                red,
            ] {(20/22)*x*e^(-(1/22)*x)};\label{plot:line3}
            \addplot[
                domain = 0:140,
                samples = 200,
                smooth,
                thick,
                magenta,
            ] {(151.72/2.9)*x*e^(-(1/2.9)*x)};\label{plot:line4}
