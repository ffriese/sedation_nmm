...
poses the obvious problem of its invasive nature and faces the challenge of realistically \iltodo{rephrase} only
...
\todo{maybe work in Steyn-Ross' argumentation, that loss of consciousness is a phenomenon global to the cortex which
further justifies the choice of population models in contrast to single neuron simulation}
