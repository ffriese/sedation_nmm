...
\todo{put this in a free text form. try to avoid starting each sentence with the likes of `at $\lambda = 0.2$, [\dots]`}
\begin{enumerate}
...
\subsection{David Friston Extension}
...
\section{Differences}
\todo{point out the differences... (maybe even in such a form as whats currently the discussion)}]
