...
\RequirePackage[backend=bibtex,
    ...
    natbib=true,
    sorting=ynt %none
]{biblatex} % Use the bibtex backend
...
\RequirePackage{enumitem} % custom enumerations
...
\newcommand\todomaybe[1]{\par
\noindent\fcolorbox{orange!70}{orange!5}{\parbox{\linegoal}{
    \fcolorbox{black!15}{yellow!15}{\small\faIcon{tasks}~ \texttt{\textcolor{black!50}{Todo (maybe)}}}
    \hspace{4pt} \texttt{\textcolor{black!40}{#1}}}}~\\
}
